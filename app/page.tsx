...
const serviceHighlights = [
  ...
  },
  {
    ...
    detail: "Encrypted checkout with trusted gateways",
  },
  {
    icon: RefreshCcw,
    title: "Easy Returns",
    detail: "Simple 7-day return policy",
  },
  {
    icon: BadgeCheck,
    title: "Authentic Craft",
    detail: "Hand-finished, artisan-made pieces",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#13060b] via-[#1a0f0f] to-[#0f0505]">
      {/* HERO SECTION */}
      <section className="relative h-[70vh] md:h-[85vh] min-h-[520px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center justify-center h-full pt-16">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-[#fbf5e9] mb-6 tracking-wide drop-shadow-2xl">
            Shades of Punjab
          </h1>
          <p className="text-[#fbf5e9]/80 max-w-2xl mb-8 text-base md:text-lg">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link
              href="/shop"
              className="group relative inline-flex items-center gap-3 px-8 py-3 md:px-10 md:py-4 border-2 border-[#c5a059] text-[#c5a059] font-heading uppercase tracking-widest text-xs md:text-sm hover:bg-[#c5a059] hover:text-[#2a0a12] transition-all duration-300 bg-black/30 backdrop-blur-sm shadow-lg"
            >
              Shop the Collection
            ...
            <Link
              href="/custom-request"
              className="inline-flex items-center gap-2 px-8 py-3 md:px-10 md:py-4 border border-[#fbf5e9]/40 text-[#fbf5e9] uppercase tracking-widest text-xs md:text-sm hover:border-[#c5a059] hover:text-[#c5a059] transition"
            >
              Custom Order
            </Link>
          </div>

          <div className="mt-10 flex flex-wrap justify-center gap-4 text-[11px] uppercase tracking-widest text-[#fbf5e9]/70">
            <span className="px-4 py-2 border border-[#fbf5e9]/20 rounded-full">2,000+ customers</span>
            <span className="px-4 py-2 border border-[#fbf5e9]/20 rounded-full">Made in Punjab</span>
            <span className="px-4 py-2 border border-[#fbf5e9]/20 rounded-full">Trusted by wedding stylists</span>
          </div>
        </div>
      </section>

      {/* SERVICE HIGHLIGHTS */}
      <section className="py-10 md:py-14 px-4 max-w-7xl mx-auto w-full">
        ...
        <div className="max-w-7xl mx-auto w-full bg-[#1a0f0f] border border-[#c5a059]/30 rounded-3xl overflow-hidden shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-0">
            <div className="relative min-h-[320px]">
              <img
                src="https://xplbznfkpfxumynuoltl.supabase.co/storage/v1/object/public/banners/deal.png"
                alt="Deal of the day"
            ...
            <div className="p-8 md:p-10 flex flex-col justify-center">
              ...
              <h3 className="text-2xl md:text-3xl font-heading text-[#fbf5e9] mt-3">Royal Maroon Sherwani Set</h3>
              <p className="text-[#fbf5e9]/70 text-sm md:text-base mt-3">
                Tailored for wedding evenings with premium brocade detailing.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categoryTiles.map((category) => (
            <Link
              ...
              className="group relative min-h-[260px] rounded-2xl overflow-hidden border border-[#c5a059]/30 shadow-lg"
            >
              <img
                src={category.image}
                alt={category.title}
      ...
      <section className="bg-[#1a0f0f] text-[#c5a059] py-16 px-6 text-center border-t border-[#c5a059]/10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-body text-base md:text-lg leading-relaxed text-[#fbf5e9]/80">
